...
<div class="col-md-6">
    ...
    <div class="form-floating mb-3">
        <input type="text" class="form-control" placeholder="Nome Completo" name="name" value="<?php echo old('name', $parent->name); ?>" id="name">
...
<div class="col-md-6">
    ...
    <div class="form-floating mb-3">
        <input type="text" class="form-control cpf" placeholder="CPF" name="cpf" value="<?php echo old('cpf', $parent->cpf); ?>" id="cpf">
...
<div class="col-md-2">
    ...
    <div class="form-floating mb-3">
        <input type="text" class="form-control" placeholder="N°" name="number" value="<?php echo old('number', $parent->address->number); ?>" id="number">
