...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/toastify/toastify.min.css'); ?>">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link <?php echo url_is(route_to('home')) ? 'active' : ''; ?>" href="<?php echo route_to('home'); ?>">
            ...
            <span class="nav-link-text ms-1">Colégio Luciano Feijão</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo url_is(route_to('students')) ? 'active' : ''; ?>" href="<?php echo route_to('students'); ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>parents</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo url_is(route_to('teachers')) ? 'active' : ''; ?>" href="<?php echo route_to('teachers'); ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>parents</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo url_is(route_to('classes')) ? 'active' : ''; ?>" href="<?php echo route_to('classes'); ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>parents</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo url_is(route_to('subjects')) ? 'active' : ''; ?>" href="<?php echo route_to('subjects'); ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>parents</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo url_is(route_to('enrollments')) ? 'active' : ''; ?>" href="<?php echo route_to('enrollments'); ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>parents</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                </script>&nbsp;Copyright © Todos os direitos reservados // Colégio Luciano Feijão
              </div>
            </div>
            <div class="col-lg-6">
