  ...
  <div class="col-12">
    <div class="card mb-4">
      <div class="card-header pb-0">
        ...
        <a href="<?php echo route_to('classes.new'); ?>" class="btn bg-gradient-dark mb-0"><i class="fas fa-plus"></i>&nbsp;&nbsp;Nova Turma</a>
      </div>
              ...
              <?php foreach ($classes as $class) : ?>
                ...
                <tr>
                  <td class="align-middle pb0">
                    ...
                    <a class="btn btn-sm bg-gradient-info" href="<?php echo route_to('classes.show', $class->code) ?>">Detalhes</a>
                  ...
                  <td>
                    <div class="d-flex>                      
                      <div>
                        <h6 class="mb-0 text-sm"><?php echo $class->name; ?></h6>
                      </div>
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="d-flex>                      
                      <div>
                        <h6 class="mb-0 text-sm"><?php echo $class->description; ?></h6>
                      </div>
                    </div>
                  </td>
